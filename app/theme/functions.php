 ...
 */
function dk_scripts() {
	wp_enqueue_style( 'dk-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'dk-style', 'rtl', 'replace' );

	wp_enqueue_script( 'dk-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
